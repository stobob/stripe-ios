...
typedef void (^STPShippingAddressValidationBlock)(NSError * __nullable validationError, NSArray<PKShippingMethod *>* shippingMethods, NSArray<PKPaymentSummaryItem*> *summaryItems);
